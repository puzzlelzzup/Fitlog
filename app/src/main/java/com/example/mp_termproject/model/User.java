...
public class User {
    ...
    // 모든 필드를 private으로 선언하여 외부에서 직접 수정하는 것을 방지 (정보 은닉)
    private String id;
    private String name;
    private String email;
    private String mobile;      // (친구 코드에서 추가)
    private String imageUrl;    // (친구 코드에서 추가)
    ...
    // private 필드에 안전하게 접근하기 위한 public get 함수들 (Getters)
    public String getId() {
        return id;
    }
